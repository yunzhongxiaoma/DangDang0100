...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath}/user/validateEmailCode" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<h4>
						第二步：输入验证码[<s:property value="#session.emailYanZheng"/>]
					</h4>
					<div class="mess">
						<span class="write_in">输入您收到邮件中的验证码：</span>
						<input name="emailYanZheng" type="text" id="validatecode" class="yzm_text" />
						<input class="finsh" type="submit" value="完 成" id="Button1" />
						<span id="errorMsg" class="no_right"></span>
					</div>
				</div>
				<s:property value="nullMessege"/>
			</div>
		</form>
